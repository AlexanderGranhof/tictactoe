import React, { useRef, FunctionComponent, DetailsHTMLAttributes } from "react";
...
const CopyText: FunctionComponent<CopyTextProps & DetailsHTMLAttributes<HTMLDivElement>> = ({ text, onCopy, hint, ...props }) => {
    ...
    return (
        <div {...props} className="copy-text-container">
